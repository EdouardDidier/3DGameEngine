...
public class OBJModel {
    ...
    public IndexedModel toIndexedModel() {
        ...
        for(int i = 0; i < result.getPositions().size(); i++)
            /*
            result.getTangents().add(normalModel.getTangents().get(indexMap.get(i))); /*/ //TODO: Which one is better?
            result.getTangents().get(indexMap.get(i)).set(normalModel.getTangents().get(indexMap.get(i)));//*/
