...
public class Shader {
    ...
    private class GLSLStruct {
        ...
        public GLSLStruct(String name, String type) {this.name = name; this.type = type;}
    }
    ...
    private HashMap<String, ArrayList<GLSLStruct>> findUniformStructs(String shaderText) {
        ...
        while(structStartLocation != -1) {
            ...
            while(componentSemicolonPos != -1 && componentSemicolonPos < braceEnd) {
                ...
                while(Character.isWhitespace(shaderText.charAt(componentNameEnd - 1)) || shaderText.charAt(componentNameEnd) == ';')
                    componentNameEnd--;
    ...
    private static String loadShader(String fileName) {
        ...
        try {
            ...
            while((line = shaderReader.readLine()) != null) {
                if(line.startsWith(INCLUDE_DIRECTIVE)) {    //#include "file.h" TODO: Manage spaces
                    shaderSource.append(loadShader(line.substring(INCLUDE_DIRECTIVE.length() + 2, line.length() - 1))).append("\n");
                }
                else
    ...
    public void setUniform(String uniformName, Matrix4f value) {
        GL20.glUniformMatrix4fv(resource.getUniforms().get(uniformName), true, Util.createFlippedBuffer(value));
    }

    //Specific Uniform Adder
